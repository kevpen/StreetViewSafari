    ...
    (function (app) {
        var StreetViewSafariApp = (function () {
            ...
            StreetViewSafariApp.prototype.handleFacebookLogin = function () {
                ...
                streetViewSafari.utility.userUtility.facebookLogin().then(function (result) {
                    if (result.existed) {
            ...
            StreetViewSafariApp.prototype.linkFacebook = function () {
                ...
                streetViewSafari.utility.userUtility.linkFacebook(parseUser).then(function (user) { return _this._handleUserLogin(new streetViewSafari.objects.User(user)); }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
            };
            StreetViewSafariApp.prototype.unlinkFacebook = function () {
                var _this = this;
                ga('send', 'event', 'unlinkFacebook', 'click');
                var parseUser = streetViewSafari.utility.userUtility.getUserFromSession();
                streetViewSafari.utility.userUtility.unlinkFacebook(parseUser).then(function (user) { return _this._handleUserLogin(new streetViewSafari.objects.User(user)); }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
            };
            StreetViewSafariApp.prototype.setFacebookUserNamePassword = function () {
                ...
                streetViewSafari.utility.userUtility.userNameExist(userName).then(function (exists) {
                    if (!exists) {
                        // username available
            ...
            StreetViewSafariApp.prototype.signup = function () {
                ...
                if (validationError) {
                    ...
                    streetViewSafari.utility.userUtility.signUp(username, email, password).then(function (user) {
                        if (user) {
            ...
            StreetViewSafariApp.prototype.login = function () {
                ...
                if (validationError) {
                    ...
                    streetViewSafari.utility.userUtility.login(username, password).then(function (user) {
                        _this.appViewModel.subFormNotificationText("");
            ...
            StreetViewSafariApp.prototype.resetPassword = function () {
                ...
                if (streetViewSafari.utility.userUtility.isUserAuthenticated()) {
                    ...
                    streetViewSafari.utility.userUtility.resetPassword(password).then(function (user) { return _this.appViewModel.subFormNotificationText("Password has been set."); }).caught(function (error) {
                        if (error && error.message) {
            ...
            StreetViewSafariApp.prototype.forgotPassword = function () {
                ...
                streetViewSafari.utility.userUtility.requestPasswordReset(email).then(function () { return _this.appViewModel.subFormNotificationText("Password reset email sent!"); }).caught(function (error) {
                    if (error && error.message) {
                        _this.appViewModel.subFormNotificationText(error.message);
                        streetViewSafari.diagnostics.Logging.logError(error);
                    }
        ...
        var SaveBase = (function () {
            ...
            SaveBase.prototype.saveWithUserACL = function () {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    parseClass.saveClass.save(_this.getSaveState()).then(function (result) { return resolve(result); }, function (error) { return reject(error); });
                });
            };
            /**
    ...
    (function (data) {
        ...
        var Query = (function () {
            ...
            Query.prototype.execute = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this._query.find().then(function (result) { return resolve(result); }, function (error) { return reject(error); });
                });
            };
            /**
            ...
            Query.prototype.executeForCount = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this._query.count().then(function (result) { return resolve(result); }, function (error) { return reject(error); });
                });
            };
            /**
            ...
            Query.prototype.first = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this._query.first().then(function (result) { return resolve(result); }, function (error) { return reject(error); });
                });
            };
...
(function (streetViewSafari) {
    ...
    (function (_data) {
        ...
        _data.StreetViewService = StreetViewService;
    })(data = streetViewSafari.data || (streetViewSafari.data = {}));
})(streetViewSafari || (streetViewSafari = {}));
var streetViewSafari;
(function (streetViewSafari) {
    ...
    (function (objects) {
        var Safari = (function (_super) {
            ...
            Safari.prototype.loadFromParse = function (parseSafari) {
                ...
                if (votePointer) {
                    ...
                    if (this.userId === streetViewSafari.utility.userUtility.getIdOfCurrentUser()) {
                        this.score = 0;
                        streetViewSafari.utility.safariUtility.createTotalScoreObject(this.id).then(function (totalVotes) {
            ...
            Safari.prototype.getClassType = function () {
                return 0 /* SafariMarker */;
            };
            Safari.prototype.getComments = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    var commentClass = new objects.ParseClass(2 /* SafariComment */);
                    var query = commentClass.getQuery();
                    query.addEqualTo("safariMarker", streetViewSafari.utility.pointerUtility.createObjectPointer(_this.id, 0 /* SafariMarker */));
                    query.sort("createdAt", 0 /* ASCENDING */);
                    query.include("user");
                    query.limit(5);
                    query.execute().then(function (results) {
                        var items = [];
                        if (results) {
            ...
            Safari.prototype.registerVote = function (voteValue) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    _this._votePointer.save().then(function (result) { return resolve(result); });
                });
            };
            Safari.prototype.remove = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this._parseObject.destroy().then(function (value) { return resolve(value); });
                });
            };
            return Safari;
        ...
        var SafariScore = (function (_super) {
            ...
            SafariScore.prototype.getSaveState = function () {
                return {
                    ...
                    "safariMarker": streetViewSafari.utility.pointerUtility.createObjectPointer(this.safariId, 0 /* SafariMarker */)
                };
            };
            SafariScore.prototype.getClassType = function () {
                return 5 /* SafariVoteTotal */;
            };
            return SafariScore;
        })(streetViewSafari.base.SaveBase);
    ...
    (function (objects) {
        var User = (function () {
            ...
            User.prototype.createAndGetUserScore = function () {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    var parseObject = new objects.ParseClass(3 /* UserVote */);
                    ...
                    query.first().then(function (userScore) {
                        if (userScore) {
                            ...
                            // create score
                            _this.createUserScore().then(function (newscore) { return resolve(newscore); }).caught(function (e) { return reject(e); });
                        }
                    }).caught(function (error) { return reject(error); });
                });
            };
            User.prototype.createUserScore = function () {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    userScore.save().then(function (result) { return resolve(result); }).caught(function (error) { return reject(error); });
                });
            };
            User.prototype.registerScore = function (voteValue) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    userScore.incrementScore(voteValue).then(function (result) { return resolve(result); }).caught(function (error) { return reject(error); });
                });
            };
            return User;
        })();
    ...
    (function (objects) {
        var UserScore = (function (_super) {
            ...
            UserScore.prototype.getSaveState = function () {
                return {
                    "user": streetViewSafari.utility.pointerUtility.createObjectPointer(this.userId, 4 /* User */),
                    "score": this.score
                };
            };
            ...
            UserScore.prototype.incrementScore = function (value) {
                var _this = this;
                return new Promise(function (resolve, reject) {
                    _this.getParseObject().then(function (result) {
                        if (result) {
                            result.increment("score", value);
                            return result.save();
                        }
                    }).then(function (updatedScore) { return resolve(updatedScore); }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
                });
            };
            UserScore.prototype.getParseObject = function () {
                var query = this.getQuery();
                query.addEqualTo("user", streetViewSafari.utility.pointerUtility.createObjectPointer(this.userId, 4 /* User */));
                return query.first();
            };
            return UserScore;
        })(streetViewSafari.base.SaveBase);
    ...
    (function (objects) {
        var Vote = (function (_super) {
            ...
            Vote.prototype.getExistingVote = function () {
                ...
                var safariPointer = streetViewSafari.utility.pointerUtility.createObjectPointer(this.safariId, 0 /* SafariMarker */);
                    ...
                    _this.getExistingVote().then(function (existingVote) {
                        if (existingVote) {
                            ...
                            if (existingVote.get("vote") != _this.getVoteValue()) {
                                ...
                                existingVote.save().then(function (result) {
                                    var returnObj = {
                                        vote: result,
                            ...
                            _this.saveWithUserACL().then(function (newVote) {
    ...
    (function (ui) {
        var AppViewModel = (function () {
            ...
            AppViewModel.prototype._initialize = function () {
                ...
                streetViewSafari.utility.safariUtility.getSafariIds().then(function (safaris) {
            ...
            AppViewModel.prototype.geocode = function () {
                ...
                if (term && term !== this.searchPlaceholder) {
                    this.geocoder.geocode(term).then(function (position) {
                        return _this.streetviewService.getPanoramaByLocation(position, 200);
                    }).then(function (data) { return _this._setPanoByLocation(data.location.latLng, null); }).caught(function (error) {
            ...
            AppViewModel.prototype._handleDragEnd = function () {
                var _this = this;
                if (this.mapVisible) {
                    var parseClass = new streetViewSafari.objects.ParseClass(0 /* SafariMarker */);
            ...
            AppViewModel.prototype._mapClicked = function (args) {
                ...
                this.streetviewService.getPanoramaByLocation(latLng, tolerance).then(function (data) {
            ...
            AppViewModel.prototype.setStartupPosition = function (latLng) {
                ...
                streetViewSafari.utility.safariUtility.findSafariWithinKilometers(geoPoint, 2).then(function (safari) {
                    if (safari) {
                        _this.setSafari(safari);
                    }
                    else {
                        _this.streetviewService.getPanoramaByLocation(latLng, 10000).then(function (data) {
            ...
            AppViewModel.prototype.logSafari = function () {
                ...
                this.streetviewService.getPanoramaById(scene.panoId).then(function (data) {
            ...
            AppViewModel.prototype.loadSafariById = function (id) {
                var _this = this;
                streetViewSafari.utility.safariUtility.getSafariById(id).then(function (safari) {
                    if (safari) {
                        _this.setSafari(safari);
                    }
                    else {
            ...
            AppViewModel.prototype.loadRandom = function () {
                ...
                var parseClass = new streetViewSafari.objects.ParseClass(0 /* SafariMarker */);
                var query = parseClass.getQuery();
                query.first().then(function (safari) {
                    if (safari) {
            ...
            AppViewModel.prototype.setSafari = function (safariDataModel) {
                ...
                if (safariDataModel) {
                    ...
                    this.streetviewService.getPanoramaById(safariViewModel.panoId).then(function (data) {
                        _this.expired(false);
        ...
        var SafariViewModel = (function () {
            ...
            SafariViewModel.prototype.setSafari = function (safari) {
                ...
                if (safari.initialized) {
                    ...
                    getVote.getExistingVote().then(function (existingVote) {
                        if (existingVote) {
            ...
            SafariViewModel.prototype.populateCommentViewModels = function () {
                var _this = this;
                this._safariDataModel.getComments().then(function (comments) {
                    var viewModels = [];
            ...
            SafariViewModel.prototype.refresh = function () {
                var _this = this;
                streetViewSafari.utility.safariUtility.getSafariById(this._safariDataModel.id).then(function (result) {
            ...
            SafariViewModel.prototype.setVoteInterface = function (vote) {
                this._vote = vote;
                if (this._vote.vote == 0 /* UP */) {
                    this.setUpVote(true);
                    this.setDownVote(false);
                }
                else if (this._vote.vote == 1 /* DOWN */) {
            ...
            SafariViewModel.prototype.saveVote = function (voteType) {
                ...
                this._vote.saveVote().then(function (returnObj) {
            ...
            SafariViewModel.prototype.updateUserScore = function (voteValue) {
                var parseUser = streetViewSafari.utility.pointerUtility.createObjectPointer(this._safariDataModel.userId, 4 /* User */);
            ...
            SafariViewModel.prototype.updateSafariScore = function (voteValue) {
                var _this = this;
                this._safariDataModel.registerVote(voteValue).then(function (updatedSafari) { return _this.refresh(); }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
            };
            SafariViewModel.prototype.handleUpVote = function () {
                this.saveVote(0 /* UP */);
            };
            SafariViewModel.prototype.handleDownVote = function () {
                this.saveVote(1 /* DOWN */);
            };
            SafariViewModel.prototype.handleDelete = function () {
                var _this = this;
                var confirm = window.confirm("Really delete the Safari?");
                if (confirm === true) {
                    this._safariDataModel.remove().then(function (result) {
            ...
            SafariViewModel.prototype.saveComment = function () {
                ...
                comment.saveWithUserACL().then(function (comment) {
                    _this.commentText("");
                    _this.refresh();
                }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
            };
    ...
    (function (ui) {
        var UserViewModel = (function () {
            ...
            UserViewModel.prototype._getUserScore = function () {
                var _this = this;
                this._userDataModel.createAndGetUserScore().then(function (score) { return _this.score(score.get("score")); }).caught(function (error) { return streetViewSafari.diagnostics.Logging.logError(error); });
            };
    ...
    (function (utility) {
        ...
        (function (safariUtility) {
            ...
            function linkTotalScoreOnSafari(safari, totalScoreId) {
                return new Promise(function (resolve, reject) {
                    safari.set("score", utility.pointerUtility.createObjectPointer(totalScoreId, 5 /* SafariVoteTotal */));
                    safari.save().then(function (result) {
                        resolve(result);
                    }, function (error) { return reject(error); });
                });
            }
        ...
        (function (userUtility) {
            ...
            function signUp(userName, email, password) {
                return new Promise(function (resolve, reject) {
                    ...
                    user.signUp(null).then(function (user) { return resolve(user); }, function (error) { return reject(error); });
                });
            }
            ...
            function login(userName, password) {
                return new Promise(function (resolve, reject) {
                    userName = userName.toLowerCase();
                    Parse.User.logIn(userName, password).then(function (user) { return resolve(user); }, function (error) { return reject(error); });
                });
            }
            ...
            function requestPasswordReset(email) {
                return new Promise(function (resolve, reject) {
                    Parse.User.requestPasswordReset(email).then(function (result) { return resolve(result); }, function (error) { return reject(error); });
                });
            }
            ...
            function resetPassword(newPassword) {
                return new Promise(function (resolve, reject) {
                    ...
                    user.save(null).then(function (user) { return resolve(user); }, function (error) { return reject(error); });
                });
            }
            userUtility.resetPassword = resetPassword;
            function userNameExist(userName) {
                var user = new streetViewSafari.objects.ParseClass(4 /* User */);
                userName = userName.toLowerCase();
            ...
            function setUsernameAndPassword(userName, password) {
                return new Promise(function (resolve, reject) {
                    ...
                    user.set("username", userName);
                    user.set("password", password);
                    user.save().then(function (user) { return resolve(user); }, function (error) { return reject(error); });
                });
            }
...
window.onload = function () {
    // Initialize Parse
    //dev
    //Parse.initialize("JjQRcwwpJAOFC0oWsOubVfEBi102lCEcLujLRK55", "tdKx7c8bR2SNFh2o8DOC0HT1UCUi7ssJp3hZhH8M");
    // prod
    Parse.initialize("nNamLPGazKwIVux0AQoAl5icbrmIhx8C6OuheQ3i", "mSqSzP43yhGhpnmXmQsIKHEToDQlGrTnamtLybUM");
    //init facebook utils
    Parse.FacebookUtils.init({
        appId: '324838301005301',
        status: true,
        cookie: true,
        xfbml: true,
